...
ListIden clone_ListIden(ListIden p);
Program clone_Program(Program p);
GlobDecl clone_GlobDecl(GlobDecl p);
ListGlobDecl clone_ListGlobDecl(ListGlobDecl p);
ImportDecl clone_ImportDecl(ImportDecl p);
Pack clone_Pack(Pack p);
ListPack clone_ListPack(ListPack p);
ClassMemDecl clone_ClassMemDecl(ClassMemDecl p);
ListClassMemDecl clone_ListClassMemDecl(ListClassMemDecl p);
TypeArg clone_TypeArg(TypeArg p);
ListTypeArg clone_ListTypeArg(ListTypeArg p);
