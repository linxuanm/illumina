 ...
 * processing. This phrase handles trivial error checks
 * such as attribute flags and location of abstract
 * functions.
 */
...
typedef struct program_t {
    ...
    union {
        ...
        struct {
            char *iden;
            struct program_t *type;
            GArray *sig; // <program_t>
            GArray *exp; // <program_t>
            bool initialized;
        } decl_var;
...
program_t *gen_ctype_just(CType);
AST_TRANS_DECL(gen_ctype_maybe(CType, bool));
AST_TRANS_DECL(gen_targs_decl(TypeArg));
